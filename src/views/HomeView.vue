  ...
  <div class="tw-container tw-bg-white">
    ...
    >
      ...
      <div class="tw-flex tw-pt-4 tw-space-x-3">
        <a
          class="tw-w-[120px] tw-text-center tw-rounded-md tw-py-2 tw-px-3 tw-text-[13px] tw-text-white tw-cursor-pointer tw-tracking-wider"
          style="background-color: #f88e42"
          >Recomendados</a
        >
        <a
          class="tw-w-[120px] tw-text-center tw-rounded-md tw-py-2 tw-px-7 tw-text-[13px] tw-text-white tw-cursor-pointer tw-tracking-wider"
    ...
    <div
      v-if="users.length"
      class="tw-px-5 md:tw-px-20 lg:tw-px-16 xl:tw-px-24 2xl:tw-px-36 tw-py-5 tw-grid tw-grid-cols-2 sm:tw-grid-cols-3 lg:tw-grid-cols-4 tw-gap-5 lg:tw-gap-8 xl:tw-gap-10 2xl:tw-gap-12"
    >
